...
input_dir = '/home/zixin/remote/mixture_mutants_1_rhat_adv/azure/mmra1'
#input_dir = '/home/zixin/remote/mnt/launch_azure/restlrm2'
resource_dir = 'stanresources'
input_container_name = input_dir.split("/")[-1]
output_container_name = input_container_name + "out"
to_create_pool = True
to_upload_file = True
to_create_job = True
to_try_10 = False
...
def add_tasks(batch_service_client, job_id, input_files, output_container_sas_url):
    ...
    for idx, input_file in enumerate(input_files):
        ...
        command = "/bin/bash -c \" \
                time sudo ../../tar_to_metrics.sh {0} &> gzip > {1}_log.txt; \
        ...
        tasks.append(batch.models.TaskAddParameter(
            ...
            output_files=[batchmodels.OutputFile(
                      file_pattern="{}*".format(input_file_name),
...
def wait_for_tasks_to_complete(batch_service_client, job_id, timeout):
    ...
    RuntimeWarning("Warning: Tasks did not reach 'Completed' state within "
...
if __name__ == '__main__':
    ...
    if to_upload_file:
        ...
        input_files = [
                get_file_from_container(blob_client, input_container_name, file_path)
                for file_path in input_file_paths]
